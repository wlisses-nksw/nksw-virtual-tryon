...
export default async function handler(req, res) {
  ...
  const info = {
    ...
    SHOPIFY_ADMIN_TOKEN:  adminToken ? `✅ começa com "${adminToken.slice(0, 10)}..."` : '❌ não definido',
  };
  ...
  try {
    const r = await fetch(`https://${shopDomain}/admin/api/2024-01/customers.json`, {
      ...
      body: JSON.stringify({ customer: { email: 'debug-test@nksw.com.br', first_name: 'Debug', accepts_marketing: true, tags: 'newsletter' } }),
    });
